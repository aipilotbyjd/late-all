...
const WorkflowActions = ({ workflow }: { workflow: any }) => (
    <Dropdown.Root>
        <Dropdown.DotsButton />
...
export const WorkflowsPageEnhanced = () => {
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <Dropdown.Root>
                                ...
                                <Dropdown.Popover>
                                    <Dropdown.Menu>
                                        ...
                                        <Dropdown.Item onAction={() => setStatusFilter("active")}>
                                            Active
                                        </Dropdown.Item>
                                        <Dropdown.Item onAction={() => setStatusFilter("paused")}>
                                            Paused
                                        </Dropdown.Item>
                                        <Dropdown.Item onAction={() => setStatusFilter("error")}>
                                            Error
                                        </Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown.Popover>
                            ...
                            <Dropdown.Root>
                                ...
                                <Dropdown.Popover>
                                    <Dropdown.Menu>
                                        <Dropdown.Item onAction={() => setCategoryFilter("all")}>
                                            All Categories
                                        </Dropdown.Item>
                                        <Dropdown.Item onAction={() => setCategoryFilter("Marketing")}>
                                            Marketing
                                        </Dropdown.Item>
                                        <Dropdown.Item onAction={() => setCategoryFilter("Communication")}>
                                            Communication
                                        </Dropdown.Item>
                                        <Dropdown.Item onAction={() => setCategoryFilter("Customer Success")}>
                                            Customer Success
                                        </Dropdown.Item>
                                        <Dropdown.Item onAction={() => setCategoryFilter("Operations")}>
                                            Operations
                                        </Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown.Popover>
