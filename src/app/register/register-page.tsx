                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm leading-6">
                                        <label htmlFor="agree-terms" className="text-gray-900">
                                            I agree to the{' '}
                                            <Link href="/terms" className="font-medium text-brand-600 hover:text-brand-500">
                                                Terms of Service
                                            </Link>{' '}
                                            and{' '}
                                            <Link href="/privacy" className="font-medium text-brand-600 hover:text-brand-500">
                                                Privacy Policy
                                            </Link>
                                        </label>
                                    </div>
                    ...
                    <div className="relative h-full flex flex-col justify-center px-12">
                        <div className="max-w-md">
                            ...
                            <p className="text-xl text-brand-100 mb-8">
                                Start automating your workflows today and save hours of manual work every week.
                            </p>
